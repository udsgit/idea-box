<template>
  <section class="mb-6">
    ...
    <p class="user-actions" v-if="!user">Please <a @click="doLogin" href="#">login</a> first</p>
    <p class="user-actions" v-else>Hi 👍 {{ user.displayName }}. <a @click="doLogout" href="#">Logout</a></p>
  </section>
</template>
...
export default {
  ...
  setup(props, { emit}){
    ...
    const addIdea = () => emit("add-idea", idea);
    idea.value = "";
